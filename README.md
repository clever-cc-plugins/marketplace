...
| [`cc-content`](https://github.com/clever-cc-plugins/cc-content) | `/cc-content:content-onboarding`, `/cc-content:register-context`, `/cc-content:research-prompt`, `/cc-content:content-ideation`, `/cc-content:atomize`, `/cc-content:linkedin-post`, `/cc-content:blog-article`, `/cc-content:facebook-post`, `/cc-content:instagram-post`, `/cc-content:press-release`, `/cc-content:marketing-email`, `/cc-content:x-post`, `/cc-content:long-tail-copy`, `/cc-content:samples-curation`, `/cc-content:session-wrap`, `/cc-content:new-content-skill`, `/cc-content:humanize`, `/cc-content:content-performance-review` | Content creation skills for marketing projects                                                      |
